...
updated: 2026-05-03T00:23:00+00:00
feature_image: /assets/images/Z1YgLvt-monkeys-waiting-in-a-tsa-line-at-the-airport--1-.png
excerpt: "In the era of AI-generated code, the real challenge isn't writing software, but intentionally designing systems around selective destruction."
---
...
For most of the history of software, deletion was something to fear. Code was expensive to produce, and systems grew slowly. Removing something meant risking weeks of work. Daily revenues that ran on the back of a finely curated *crontab* that ran every important service, obliterated by using a damn *-r* instead of a *-e* [[note: Confession | Yes, that was me. *-e* means edit; *-r* means remove. [Not alone](https://www.reddit.com/r/linux/comments/1eea629/who_thought_that_crontab_r_was_a_good_idea/), tho'.]]. Entire subsystems were treated with a mix of reverence and fear, like some code version of Kitum Cave[[note: Source | A [cave in Kenya](https://en.wikipedia.org/wiki/Kitum_Cave), believed to be the source of deadly diseases like Ebola.  I'll bet it's probably hosting an unsecured version of Wordpress, too.]], simply because so much time had been invested in them and so much could go wrong. Once something was written, whether an algorithm or a README, it tended to stay written.
...
Which brings us back to that text message and that now deleted database. And for my buddy, yes, he had backups[[note: No, really | This actually happened to a buddy, but it's happened to [lots of people](https://www.theguardian.com/technology/2026/apr/29/claude-ai-deletes-firm-database) with some pretty bad ramifications.]], and more tokens to burn.
